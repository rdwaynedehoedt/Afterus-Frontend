    ...
    <div className="flex min-h-[calc(100dvh-7rem)] flex-col items-center justify-center px-4 pb-24 sm:min-h-[calc(100vh-6rem)] sm:px-6 sm:pb-8">
      ...
      >
        ...
        >
          <Link
            href="/journal/new"
            className="inline-flex w-full justify-center rounded-2xl bg-[var(--cta-bg)] px-6 py-3.5 text-sm font-semibold text-[var(--cta-text)] transition-all active:scale-[0.98] hover:opacity-90 sm:w-auto sm:px-8 sm:py-4 sm:text-base sm:hover:scale-[1.02]"
          >
            Write anonymously
          </Link>
        </motion.div>
