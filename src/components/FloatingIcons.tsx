...
const icons = [
  ...
  { icon: "waves", x: "25%", y: "8%", delay: 0.3, duration: 7, size: 38, rotate: -3, tint: "blue" },
  { icon: "waves", x: "78%", y: "85%", delay: 1.2, duration: 9, size: 36, rotate: 5, tint: "blue" },
  { icon: "palm", x: "3%", y: "35%", delay: 2, duration: 10, size: 42, rotate: -8, tint: "lavender" },
  { icon: "palm", x: "96%", y: "45%", delay: 0.8, duration: 11, size: 38, rotate: 10, tint: "lavender" },
  ...
  { icon: "droplet", x: "30%", y: "15%", delay: 2.2, duration: 8, size: 24, rotate: -10, tint: "blue" },
  { icon: "droplet", x: "72%", y: "78%", delay: 1, duration: 7, size: 26, rotate: 12, tint: "blue" },
  { icon: "droplet", x: "50%", y: "5%", delay: 0.7, duration: 9, size: 22, rotate: -4, tint: "blue" },
  ...
  { icon: "fish", x: "22%", y: "88%", delay: 0.4, duration: 9, size: 32, rotate: -6, tint: "blue" },
  { icon: "fish", x: "75%", y: "35%", delay: 2.1, duration: 7, size: 28, rotate: 8, tint: "blue" },
